...
from app import db, limiter, oauth  # Agent5: import shared limiter
...
def oauth_callback(provider):
    ...
    try:
        ...
        current_app.logger.error(f"OAuth error: {e!s}")
...
def get_user_info_from_provider(provider, token):
    ...
    try:
        ...
        current_app.logger.error(f"Error getting user info: {e!s}")
        return None
